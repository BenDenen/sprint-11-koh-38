...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val retrofit = Retrofit.Builder()
            .baseUrl("https://raw.githubusercontent.com/BenDenen/sprint-11-koh-38/")
            .addConverterFactory(
                GsonConverterFactory.create(
                    GsonBuilder()
                        .registerTypeAdapter(Date::class.java, CustomDateTypeAdapter())
                        .registerTypeAdapter(NewsItem::class.java, NewsItemsAdapter())
                        .create()
                )
            )
            .build()
...
// https://raw.githubusercontent.com/BenDenen/sprint-11-koh-34/refs/heads/master/jsons/news_1.json
