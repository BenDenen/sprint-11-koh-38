...
class NewsItemsAdapter : JsonDeserializer<NewsItem> {
    ...
    override fun deserialize(
        ...
        return when(typeString) {
            "sport" -> context.deserialize(json, NewsItem.SportNewsItem::class.java)
            "science" -> context.deserialize(json, NewsItem.ScienceNewsItem::class.java)
            else -> context.deserialize(json, NewsItem.DefaultNewsItem::class.java)
        }
    }
